...
def get_model():
    global MODEL
    if MODEL is None:
        MODEL = kenlm.LanguageModel('/data/voice/train-data/ModelAsr/LanguageModel/kenlm-LM/kenlm-model.binary')
    return MODEL
...
def edits1(word):
    ...
    letters    = 'aàáảạãăằắẳặẵâầấẩậẫbcdđeèéẻẹẽêềếểệễghiìíỉịĩklmnoòóỏọõôồốổộỗơờớởợỡpqrstuùúủụũưừứửựữvxyỳýỷỵỹ'
